...
class Relations {
    ...
    addWithGraphLib (fore, later, type) {
        this.hb.push({fore, later, type});
    ...
    _getCompleteGraph () {
        this.completeGraph = dijkstraAll(this._graph);
    }

    __completeHappensBeforeWithGraphLib () {
        return this.completeGraph[ei][ej].distance > 0 &&
            this.completeGraph[ei][ej].distance != Number.POSITIVE_INFINITY;
    }
    ...
    computePath (source) {
        return dijkstra(this._graph, source);
    }
