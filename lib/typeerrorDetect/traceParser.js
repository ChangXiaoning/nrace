    ...
    function processLine (line, last) {
        ...
        if (line) {
             ...
             */
                ...
                eventOp = new EventOperation('register', lineno, metadata[3], metadata[1]);
        ...
        if (last) {
            ...
            */
            that.eventManager.enhanceTrace();
            /** Test the result of enhanced trace */
            /*
            console.log('Enhanced trace:');
            for (var [id, event] of that.eventManager.virtualEvents.entries()) {
                debugHelper('==========' + id);
                writeObj(event);
            }*/
