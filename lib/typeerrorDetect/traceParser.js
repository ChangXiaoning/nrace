    ...
    function processLine (line, last) {
        ...
        if (line) {
            ...
            if (entryType == LogEntryType['CREATE_OBJ']) {
                ...
                record = new ObjectRecord(lineno,metadata[2], entryTypeName, metadata[1], that.eventManager.top());
                ...
                if (metadata[4] > 0) {
                    record = new ObjectRecord(lineno, metadata[4], entryTypeName, metadata[1], that.eventManager.top());
                }
