    ...
    function processLine (line, last) {
        ...
        if (line) {
            ...
            if (entryType == LogEntryType['SOURCE_MAPPING']){
                 ...
                 */
                that.locationManager.addiid(metadata[1], metadata.slice(2, 6));
                ...
                */
                ...
                if (debug) {
                    debugHelper('create an event with id ' + event.id);
                }
                ...
                */
                ...
                /**
                 * log format: entryType, iid, functionEnterIid, objId
