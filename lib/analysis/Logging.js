...
var AbstractFluentTracer = (function (_super) {
    ...
    AbstractFluentTracer.prototype.logFunctionEnter = function (iid, current) {
        if (!this.beforeLog() || !LogEntryType.hasOwnProperty('FUNCTION_ENTER'))
            return;
        this.flushIfNeeded().writeTypeAndIID(LogEntryType["FUNCTION_ENTER"], iid).writeInt(current).writeRt();
    };
