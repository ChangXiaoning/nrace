...
//xiaoning: iterate over the util property to attach it to ___TraceCollector___
...
(function (___TraceCollector___) {
    ...
    var AbstractFluentTracer = (function (_super) {
        ...
        AbstractFluentTracer.prototype.logAsyncPromiseResolve = function(asyncId, eid){
            if (!this.beforeLog())
                return;
            this.flushIfNeeded().writeType(LogEntryType["ASYNC_PROMISERESOLVE"]).writeInt(asyncId).writeInt(eid).writeRt();
        } 
